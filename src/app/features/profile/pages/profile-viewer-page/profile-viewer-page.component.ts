...
export class ProfileViewerPageComponent {
  ...
  profileId = signal<string>('beflim');
  isModalOpen = signal<boolean>(false);
  isMobile = signal<boolean>(false);
  themeColors = signal<string[]>([]);
  gradientColor1 = signal<string>('#1e293b');
  gradientColor2 = signal<string>('#7e22ce');
  gradientColor3 = signal<string>('#1e293b');
  ...
  constructor() {
    ...
    effect(() => {
      ...
      const newId = params.get('id') || 'beflim';
